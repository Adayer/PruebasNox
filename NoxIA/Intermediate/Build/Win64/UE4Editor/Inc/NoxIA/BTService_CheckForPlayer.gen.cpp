...
#include "NoxIA/IA/BTService_CheckForPlayer.h"
#ifdef _MSC_VER
#pragma warning (push)
...
// Cross Module References
	NOXIA_API UClass* Z_Construct_UClass_UBTService_CheckForPlayer_NoRegister();
	NOXIA_API UClass* Z_Construct_UClass_UBTService_CheckForPlayer();
...
// End Cross Module References
	...
	const UE4CodeGen_Private::FMetaDataPairParam Z_Construct_UClass_UBTService_CheckForPlayer_Statics::Class_MetaDataParams[] = {
		{ "Comment", "/**\n * \n */" },
		{ "IncludePath", "IA/BTService_CheckForPlayer.h" },
		{ "ModuleRelativePath", "IA/BTService_CheckForPlayer.h" },
	};
#endif
	...
	IMPLEMENT_CLASS(UBTService_CheckForPlayer, 746098192);
	template<> NOXIA_API UClass* StaticClass<UBTService_CheckForPlayer>()
	{
		return UBTService_CheckForPlayer::StaticClass();
	}
	static FCompiledInDefer Z_CompiledInDefer_UClass_UBTService_CheckForPlayer(Z_Construct_UClass_UBTService_CheckForPlayer, &UBTService_CheckForPlayer::StaticClass, TEXT("/Script/NoxIA"), TEXT("UBTService_CheckForPlayer"), false, nullptr, nullptr, nullptr);
